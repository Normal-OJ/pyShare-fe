...
const Auth = {
  ...
  changeEmail: body => Vue.axios.post('/auth/change/email', body),
  validateEmail: body => Vue.axios.post('/auth/check/email', body),
}
...
const Course = {
  ...
  update: (id, body) => Vue.axios.put(`/course/${id}`, body),
